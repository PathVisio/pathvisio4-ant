...
/**
 * Possible values for the cellular component property. These values describe
 * the biological meaning of an element, it does not have to correlate with a
 * particular appearance.
 */
public enum CellularComponentType {
	NONE("None"), CELL("Cell"), NUCLEUS("Nucleus"), MITOCHONDRIA("Mitochondria"), GOLGIAPPARATUS("Golgi Apparatus"),
	ENDOPLASMICRETICULUM("Endoplasmic Reticulum"), SARCOPLASMICRETICULUM("Sarcoplasmic Reticulum"), VESICLE("Vesicle"),
	...
	static {
		for (CellularComponentType t : values())
			byGpmlName.put(t.gpmlName, t);
	}
