...
public enum StaticProperty implements Property {
	...
	// datanode
	ALIASREF("aliasRef", "Alias Reference", StaticPropertyType.STRING, 200, false, true, false),
	...
	FONTSIZE("fontSize", "Font Size", StaticPropertyType.INTEGER, 256), // TODO used to be double
