...
public class OkCancelDialog extends JDialog implements ActionListener {
	...
	/**
	 * Create a dialog with ok/cancel buttons. A custom content component can be set
	 * using {@link #setDialogComponent(Component)}.
	 * 
	...
	public OkCancelDialog(Frame frame, String title, Component locationComp, boolean modal, boolean cancellable) {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().createImage(Resources.getLogo())); // UI Design
	...
	/**
	 * Set the component that contains the dialog contents. Subclasses must call
	 * this method to set custom dialog contents.
	 * 
