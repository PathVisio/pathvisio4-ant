...
public class XrefHandler extends AbstractCellEditor
	...
	private static final String BUTTON_LABEL = "View/edit database:id";
	private static final String BUTTON_COMMAND = "editDatabaseId";
	...
	public PropertyType getType() {
		return StaticPropertyType.XREF;
	}
	...
	public Object getCellEditorValue() {
		if (currentElement instanceof Xrefable) {
			return ((Xrefable) currentElement).getXref();
		} else {
			return null;
		}
	}
