 ...
 * @author finterly
 */
public class AliasRefHandler extends AbstractCellEditor
		implements ContextSensitiveEditor, TableCellEditor, TypeHandler, ActionListener {
	private static final String BUTTON_LABEL = "View/edit linked group";
	private static final String BUTTON_COMMAND = "editLinkedGroup";
	...
	public PropertyType getType() {
		return StaticPropertyType.ALIASREF;
	}
	...
	public Object getCellEditorValue() {
		if (currentElement.getObjectType() == ObjectType.DATANODE) {
			return ((DataNode) currentElement).getAliasRef();
		} else {
			return null;
		}
	}
