...
public class PathwayModelTransferable implements Transferable {
	...
	public Object getTransferData(DataFlavor flavor) throws UnsupportedFlavorException, IOException {
		...
		for(PathwayObject e : elements) {
			...
			if(!ids.contains(enew.getEndElementRef())) {
				enew.setEndElementRef(null);
			}
			pnew.add(enew);
	 ...
	 * @throws IOException
	 */
	public static PathwayModel pathwayModelFromTransferable(Transferable t) throws ConverterException, MalformedURLException, UnsupportedFlavorException, IOException {
		PathwayModel pnew = new PathwayModel();
	 ...
	 * @throws ConverterException
	 */
	public static void openPathwayModelFromTransferable(Transferable t, Engine engine) throws UnsupportedFlavorException, IOException, ConverterException {
		URL url = getFileURL(t);
		if(url != null) {
